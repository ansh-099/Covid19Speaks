...
const LatestScreen = () => {
  ...
  const response = await djangoapi.post('/api/all/getrangedunits/',{'start': state.start, 'end': state.start+ 10},{headers: {
  ...
  return (
      ...
      <Header
        ...
        centerComponent={{ text: 'Latest Feed' , style: styles.writing}}
        />
        <FlatList
        onEndReached={() => {
          add_elements();
...
LatestScreen.navigationOptions = {
  tabBarIcon: <Entypo name="new" size={28} color="black" />
